...
DECLARE
  ...
  v_email text := 'superadmin@nocap.life';
  v_password text := 'swipe2GO#';
  v_existing uuid;
BEGIN
  ...
  VALUES (v_user_id, 'Super Admin', public.generate_referral_code())
  ON CONFLICT (user_id) DO UPDATE SET full_name = 'Super Admin';
